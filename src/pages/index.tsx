      ...
      <div className="header">
        <div className="container">
          ...
          <div className="texto-2">
            Somos expertos en crear contenido digital y narrativas que REALMENTE
            CONECTAN con tu audiencia potencial.
          </div>
            ...
            <div className="caja-derecha">
              ...
              <div className="texto">
                ...
                <p>
                  ...
                  las necesidades de tu negocio y tomando en cuenta la audiencia
                  a la que te diriges. 
                </p>
                <p>
                  Más que un equipo multi-disciplinario, Insight Agency cuenta
                  con un equipo que se extiende a través de todos los
                  conocimientos que nos permitirán dar un servicio de calidad a
                  tu marca o empresa.
                </p>
              </div>
            </div>
            ...
            <div className="blog">
              ...
              <div className="info">
                ...
                <p>
                  ...
                  bibendum natoque ultrices viverra at dui libero. Egestas proin
                  nunc in ipsum ullamcorper sit nibh pellentesque.
                </p>
                <div className="boton">
            ...
            <div className="caja-derecha">
              ...
              <div className="texto">
                <p>
                  ...
                  posible con una propuesta de negocio para ti.
                </p>
                <p>
                  Somos los creadores para las empresas que quieren potenciar su
                  negocio
                </p>
              </div>
            </div>
